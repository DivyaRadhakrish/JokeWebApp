...
namespace JokeWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            return _context.Joke != null ?
                             View("Index", await _context.Joke.Where(j=> j.JokeQuestion.Contains(SearchPhrase)).ToListAsync()) :  // in the Index View, Where Joke question which contains the searchphrase, should return the Joke
                        Problem("Entity set 'ApplicationDbContext.Joke'  is null.");
        }
